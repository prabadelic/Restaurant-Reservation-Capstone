...
describe("US-06 - Reservation status", () => {
  ...
  describe("POST /reservations", () => {
    // Generate a dynamic future reservation date
    const reservationDate = new Date();
    reservationDate.setDate(reservationDate.getDate() + 1); // Tomorrow's date
    const formattedDate = reservationDate.toISOString().split("T")[0]; // YYYY-MM-DD format
